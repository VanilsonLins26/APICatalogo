...
namespace APICatalogo.Repositories
{
    public class ProdutoRepository : Repository<Produto>, IProdutoRepository
    {
        ...
        public async Task<IPagedList<Produto>> GetProdutosAsync(ProdutosParameters produtosParams)
        {
            ...
            //var resultado = PagedList<Produto>.ToPagedList(produtosOrdenados, produtosPrams.PageNumber, produtosPrams.PageSize);
        ...
        public async Task<IPagedList<Produto>> GetProdutosFiltradosAsync(ProdutosFiltroPreco produtosFiltroParams)
        {
            var produtos = await GetAllAsync();
        ...
        {
            var produtos = await GetAllAsync();
            var produtosCategoria = produtos.OrderBy(p => p.ProdutoId);
